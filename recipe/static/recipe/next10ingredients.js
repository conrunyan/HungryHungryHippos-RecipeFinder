...
function Next10(recipes) {
    ...
    var getNextIndices=function() {
        ...
        // increment indices
        var next_start_idx = rec_start_idx + 1;
        ...
        if (rec_start_idx == num_recs - 1)
        {
            ...
            next_start_idx = rec_start_idx;
            next_end_idx = rec_start_idx;
            next_indices[START] = next_start_idx;
            next_indices[END] = next_end_idx;
        }
        // else if the ending index is greater than rec_nums, return rec_nums
        // as the ending index, and next_start_idx as the staring index
